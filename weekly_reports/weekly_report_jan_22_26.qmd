...
- Decided to remove any rows that did not report a new case for that day.
  - Would have meant we would be imputing our target variable and ultimatley decided it woudl be beneficial to remove it entirely.
  - Updated data set: **48,877** observations of **67** columns
    - Still a lot of missing data
