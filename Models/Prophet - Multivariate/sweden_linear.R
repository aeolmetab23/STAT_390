...
MLmetrics::MAPE(y_pred = Sweden_preds$new_cases, y_true = Sweden_preds$preds) # 1.703476

Sweden_metrics
# 1 rmse    standard     15773.  
# 2 mase    standard        46.3
# 3 mae     standard     12100.  
# 4 mape    standard         1.703476
