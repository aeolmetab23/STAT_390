...
# components of model
prophet_plot_components(uk_fit, uk_forecast,
...
MLmetrics::MAPE(y_pred = uk_preds$new_cases, y_true = uk_preds$preds) # 1.290901

uk_metrics
# 1 rmse    standard     57822.  
# 2 mase    standard        25.6
# 3 mae     standard     48195.  
# 4 mape    standard         1.290901
