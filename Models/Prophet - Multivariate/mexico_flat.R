...
MLmetrics::MAPE(y_pred = mexico_preds$new_cases, y_true = mexico_preds$preds) # 1.405161

mexico_metrics
# 1 rmse    standard     35231.  
# 2 mase    standard        26.9
# 3 mae     standard     28548.  
# 4 mape    standard         1.405161
