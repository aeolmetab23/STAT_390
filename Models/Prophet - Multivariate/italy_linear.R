...
# model
italy_model <- prophet(df = NULL, growth = "linear",
                       yearly.seasonality = FALSE, weekly.seasonality = TRUE,
...
# Metrics
MAPE(y_pred = italy_preds$new_cases, y_true = italy_preds$preds) # 2.267725
mase_vec(truth = italy_preds$new_cases, estimate = italy_preds$preds) # 15.96826
