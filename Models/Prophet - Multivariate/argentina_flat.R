...
MLmetrics::MAPE(y_pred = argentina_preds$new_cases, y_true = argentina_preds$preds) # 1.031767

argentina_metrics
# 1 rmse    standard     72642.  
# 2 mase    standard        34.1
# 3 mae     standard     64234.  
# 4 mape    standard         1.031767
