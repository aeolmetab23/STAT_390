...
MLmetrics::MAPE(y_pred = peru_preds$new_cases, y_true = peru_preds$preds) # 1.23921

peru_metrics
# 1 rmse    standard     15916.  
# 2 mase    standard        20.8
# 3 mae     standard     10887.  
# 4 mape    standard         1.23921
